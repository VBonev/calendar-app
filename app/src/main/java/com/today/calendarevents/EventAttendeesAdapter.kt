...
class EventAttendeesAdapter(private val attendees: List<EventAttendee>) : RecyclerView.Adapter<EventAttendeesAdapter.AttendeeViewHolder>() {
    ...
    inner class AttendeeViewHolder(inflater: LayoutInflater, parent: ViewGroup) :
        ...
        private var mail: TextView? = itemView.findViewById(R.id.attendee_name)

        fun bind(attendee: EventAttendee) {
            title?.text = attendee.name
            mail?.text = attendee.email
